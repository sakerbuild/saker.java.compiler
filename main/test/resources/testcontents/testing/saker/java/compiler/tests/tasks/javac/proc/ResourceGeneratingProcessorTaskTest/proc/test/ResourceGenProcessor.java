	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
		for (Element e : roundEnv.getRootElements()) {
			...
			try {
				...
				String genname = qnamed.getQualifiedName().toString() + ".txt";
				FileObject outres = filer.createResource(genLocation, elements.getPackageOf(e).getQualifiedName().toString(), genname, e);
