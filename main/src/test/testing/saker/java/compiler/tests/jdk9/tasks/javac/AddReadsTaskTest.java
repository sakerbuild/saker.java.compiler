...
@SakerTest
public class AddReadsTaskTest extends JavaCompilerVariablesMetricEnvironmentTaskTestCase {

	@Override
	protected void runNestTaskTestImpl() throws Throwable {
		runScriptTask("cmdline");
		assertEquals(getMetric().getCompiledJavacPasses(), setOf("cmdline", "first"));
		runScriptTask("cmdline");
