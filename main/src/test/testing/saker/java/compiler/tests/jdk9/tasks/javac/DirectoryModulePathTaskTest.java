...
@SakerTest
public class DirectoryModulePathTaskTest extends JavaCompilerVariablesMetricEnvironmentTaskTestCase {
	...
	protected void runNestTaskTestImpl() throws Throwable {
		...
		files.putFile(
				PATH_WORKING_DIRECTORY
						.resolve("firstmodule/" + SimpleClass.class.getName().replace('.', '/') + ".class"),
