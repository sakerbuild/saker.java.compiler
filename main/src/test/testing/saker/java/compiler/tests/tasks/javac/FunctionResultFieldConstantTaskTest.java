...
@SakerTest
public class FunctionResultFieldConstantTaskTest extends JavaCompilerVariablesMetricEnvironmentTaskTestCase {
	...
	protected void runNestTaskTestImpl() throws Throwable {
		...
		files.putFile(MAIN_JAVA_PATH, files.getAllBytes(MAIN_JAVA_PATH).toString().replace("System.out.println(args);",
